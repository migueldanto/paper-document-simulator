...
const buildDir = path.resolve(baseDir, "../build/paper-document-simulator");
...
async function main() {
  ...
  if (argLocal) {
    ...
    console.info(`build: package.name = "@${localKey}/paper-document-simulator"`);
    pkg.name = `@${localKey}/paper-document-simulator`;
  }
